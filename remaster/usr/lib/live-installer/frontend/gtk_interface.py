...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_INSTALL] = WizardPage(_("Installing the system..."), "install.png")
    ...
    def i18n(self):
        ...
        self.wTree.get_widget("label_grub_help").set_label(_("Para evitar problemas use sempre a MBR da partição que vai instalar o sistema.\nExemplos:\n/dev/sda1 2 3 ..., mbr é /dev/sda, /dev/sdb1 2 3 ..., mbr é /dev/sdb \nNa dúvida use o botão voltar para confirmar a partição correta escolhida no particionamento."))
        ...
        # hdd page
        self.wTree.get_widget("label_radio_hdd").set_label(_("Install Remaster Linux on the selected drive:"))
